document.getElementById('registration-form').addEventListener('submit', function(event) {
    ...
    // Debug: Check if values are correctly captured
    console.log("Form Data Collected:", {
        firstName, lastName, email, password, accountType, profilePicture, age, referrer, bio
    });
    ...
    emailjs.send("service_bntc24", "template_bntc24", {
        ...
        document.getElementById("registration-form").reset(); // Reset form after success
